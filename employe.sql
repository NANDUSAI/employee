...
(1, 'Nandu', 'nandusai982000@gmail.com', 'Nice ui');
...
127.0.0.1/employe/transactions/	 http://localhost:8080/phpmyadmin/index.php?route=/sql&server=1&db=employe&table=transactions&pos=0
...
127.0.0.1/employe/users/		http://localhost:8080/phpmyadmin/index.php?route=/sql&server=1&db=employe&table=transactions&pos=0
